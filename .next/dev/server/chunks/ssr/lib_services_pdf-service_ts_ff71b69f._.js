...
class PDFService {
                ...
                sections: [
                    {
                        ...
                        children: [
                            ...
                            ...textPages.flatMap((pageText, index)=>{
                                ...
                                // Add text content
                                if (pageText.trim()) {
                                    pageElements.push(...this.groupSentencesIntoParagraphs(pageText.split(/[.!?]+/)).map((paragraph)=>new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Paragraph"]({
                                            children: [
                                                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextRun"]({
                                                    text: paragraph.trim(),
                                                    size: 20
                                    ...
                                    pageElements.push(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Paragraph"]({
                                        children: [
                                            new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$docx$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextRun"]({
   ...
   */ static async encrypt(options) {
        ...
        try {
            ...
            const { EncryptionService } = await __turbopack_context__.A("[project]/lib/services/encryption-service.ts [app-ssr] (ecmascript, async loader)");
...
//# sourceMappingURL=lib_services_pdf-service_ts_ff71b69f._.js.map