...
class TranslationService {
   ...
   */ static async translatePDF(options) {
        ...
        const pages = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$pdf$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PDFService"].extractTextFromPDF(file);
        ...
        const translatedPdf = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$pdf$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PDFService"].createPDFfromTextPages(translatedPages);
    ...
    /** Lazily initialize and cache the translation pipeline using local models only. */ static async getTranslator(modelId) {
        if (!this.cache[modelId]) {
            this.cache[modelId] = (async ()=>{
                ...
                if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
                ;
                const { pipeline, env } = await __turbopack_context__.A("[project]/node_modules/@xenova/transformers/src/transformers.js [app-client] (ecmascript, async loader)");
...
//# sourceMappingURL=lib_services_61d50daf._.js.map