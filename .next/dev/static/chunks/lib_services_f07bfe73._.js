...
class PDFService {
   ...
   */ static async encrypt(options) {
        ...
        try {
            const { blob } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$encryption$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EncryptionService"].encryptPDF(file, {
                password,
                permissions,
                algorithm: 'PDF-Standard'
            });
...
//# sourceMappingURL=lib_services_f07bfe73._.js.map